...
public class Easy extends World
{
    ...
    {    
        ...
        addObject(new monster(), 13, 11);
        addObject(new monster(), 23, 17);
        addObject(new monster(), 17, 35);
        addObject(new food(), 7, 1);addObject(new food(), 13, 1);addObject(new food(), 21, 1);addObject(new food(), 39, 1);
        addObject(new food(), 3, 5);addObject(new food(), 25, 5);addObject(new food(), 13, 7);addObject(new food(), 35, 7);
        addObject(new food(), 7, 11);addObject(new food(), 17, 11);addObject(new food(), 21, 17);addObject(new food(), 33, 17);
        addObject(new food(), 3, 21);addObject(new food(), 11, 21);addObject(new food(), 25, 23);addObject(new food(), 19, 23);
        addObject(new food(), 13, 27);addObject(new food(), 27, 27);addObject(new food(), 7, 31);addObject(new food(), 39, 31);
        addObject(new food(), 1, 35);addObject(new food(), 11, 35);addObject(new food(), 27, 35);addObject(new food(), 21, 33);
    }
